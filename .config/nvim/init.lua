...
require('lazy').setup({
  ...
  --     logo_tooltip = 'Yes I use (n)vim btw.', -- nil or string
  ...
  --     workspace_text = 'github/arnvgh', -- Format string rendered when in a git repository (either string or function(project_name: string|nil, filename: string): string)
