...
alias ydl='i=1; yt-dlp --playlist-start $i -f "bestvideo[height<=720]+bestaudio/best[height<=720]" -o "%(playlist_index)s. %(title)s.%(ext)s"'
alias mm='ncmpcpp'
alias nw='newsboat'
alias wk='cat ~/notes/week.md'
# alias dy='cat ~/notes/daily.md'
alias vd='v ~/notes/dump'
alias y='yazi'
